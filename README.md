...
🗺️ Geração de um grafo com 20 células aleatórias
📊 Cálculo de risco para cada região mapeada
🛰️ Geração de focos de calor com temperaturas aleatórias simulando captação via satélite
